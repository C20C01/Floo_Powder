...
import io.github.c20c01.item.LastingPowder;
...
public class CCMain {
    ...
    static {
        ...
        PORTAL_BOOK_ITEM = ITEMS.register(PORTAL_BOOK_ID, () -> new PortalBook(new Item.Properties().tab(TAB).stacksTo(1).rarity(Rarity.EPIC)));
